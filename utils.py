...
def cbam_block(inputs):
    ...
    def spatial_attention(input_feature):
        ...
        spatial_attention_feature = Conv1D(filters = 1, kernel_size=7, padding='same', activation='sigmoid')(concat)   
        #1 7
...
def Phos1(nb_classes, nb_layers,img_dim1,img_dim2,img_dim3,img_dim4,img_dim5,img_dim6, init_form, nb_dense_block,
    ...
    phos_model = Model(inputs=[main_input,input2,input3], outputs=[xy], name="multi-DenseNet")
...
def getMatrixLabelFingerprint(positive_position_file_name, window_size=51, empty_aa = '*'): 
    ...
    for index in range(16660,len(rawseq11)):
      ...
      #M=Matr[:19749]
      #np.save(file="contigs.npy",arr=M) Matr=np.load(file="c7.npy")
